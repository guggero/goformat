...
// (it panicked with reflect.Set: *dst.BinaryExpr not assignable to
// *dst.BasicLit) and must leave it untouched — import lines can't wrap and
// lnd's `ll` linter exempts them anyway.
import (
